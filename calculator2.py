...
def submit_number(number):
    ...
    if "." in display.get():
        decimal_button.config(bg="red",state=DISABLED)
...
def operate(operator):
    ...
    decimal_button.config(bg="black",state=NORMAL)
...
def equal():
    if operation =='add':
       value= float(first_number) + float(second_number)+float(display.get())
        ...
        value= float(first_number) ** float(display.get())
    print(first_number,display.get(),display.get())
...
quit_button=tkinter.Button(button_frame,text='Quit',font=button_font,bg="red", command =root.destroy)

inverse_button=tkinter.Button(button_frame,text='1/x',font=button_font,bg=dark_green,command=inverse)
square_button=tkinter.Button(button_frame,text='xɅn ',font=button_font,bg=dark_green,command=square)
exponent_button=tkinter.Button(button_frame,text='Xxn',font=button_font,bg=dark_green,command=lambda:operate('exponent'))
divide_button=tkinter.Button(button_frame,text='/',font=button_font,bg=dark_green,command=lambda:operate('divide'))
multiply_button=tkinter.Button(button_frame,text='x',font=button_font,bg=dark_green,command=lambda:operate('multiply'))
add_button=tkinter.Button(button_frame,text='+',font=button_font,bg=dark_green,command=lambda:operate('add'))
subtract_button=tkinter.Button(button_frame,text='-',font=button_font,bg=dark_green,command=lambda:operate('subtract'))
...
quit_button.grid(row=0,column=2,pady=1,columnspan=2,sticky='WE')
